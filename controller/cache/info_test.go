...
`,
		...
		{
			name: "GameDeployment fully updated",
			manifest: `
apiVersion: game.kruise.io/v1alpha1
kind: GameDeployment
metadata:
...
`,
			expected: []v1alpha1.InfoItem{
				{Name: "desired", Value: "5"},
				{Name: "updated", Value: "5"},
				{Name: "updated-ready", Value: "5"},
				{Name: "ready", Value: "5"},
				{Name: "total", Value: "5"},
			},
		},
...
`,
		...
		{
			name: "GameStatefulSet fully updated",
			manifest: `
apiVersion: game.kruise.io/v1alpha1
kind: GameStatefulSet
metadata:
...
`,
			expected: []v1alpha1.InfoItem{
				...
				{Name: "ready-replicas", Value: "3"},
				{Name: "current-replicas", Value: "3"},
				{Name: "updated-replicas", Value: "3"},
				{Name: "updated-ready-replicas", Value: "3"},
			},
		},
	}
